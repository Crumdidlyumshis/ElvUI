...
L["Allows BigWigs to rename specific encounter spells on your castbar to something better to understand.\nExample: 'Impaling Eruption' becomes 'Frontal' and 'Twilight Massacre' becomes 'Dash'."] = "Позволяет BigWigs переименовывать определенные заклинания боссов на вашей полосе применения, чтобы их было легче понять.\nПример: 'Протыкающее извержение' становится 'Фронт', а 'Сумеречная резня' становится 'Рывок'."
L["Add Aura ID"] = "Добавить ID ауры"
L["Remove Aura"] = "Удалить ауру"
L["Select Aura"] = "Выбрать ауру"
L["Add an aura to the filter. Aura IDs can be acquired using the tooltip to find the correct ID."] = "Добавить ауру в фильтр. ID ауры можно получить в подсказке, чтобы найти правильный ID."
...
L["Change the scale of the Game Menu which shows up when you press ESC."] = "Изменяет масштаб игрового меню, которое появляется при нажатии ESC."
...
L["Display Modified Rate"] = "Отображать измененный множитель"
...
L["Quest Progress and Error Text"] = "Прогресс задания и текст ошибки"
...
L["Hide Quest Progress and Error Text"] = "Скрыть прогресс задания и текст ошибки"
...
L["Hides the yellow quest progress text and red error text at the top of the screen while in combat."] = "Скрывает желтый текст прогресса задания и красный текст ошибки в верхней части экрана во время боя."
L["High"] = "Верхний"
...
L["Private (Character Settings)"] = "Личные (Настройки персонажа)"
